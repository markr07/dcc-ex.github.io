...
Refer to the :doc:`/about/contributing/software` page, in particular the section related to :ref:`about/contributing/software:Python 3.x`, :ref:`GitHub Desktop <about/contributing/software:other handy git software>` and :ref:`VSCode <about/contributing/software:Recommended editor (VSCode)>` for the software necessary to contribute to the documentation.
...
You can open the repository in VSCode at any time by using :menuselection:`File --> Open Folder` and navigating to the folder you selected in step 2.

You can subsequently open the repository in VSCode using :menuselection:`File --> Open Recent` and selecting the repository name.
