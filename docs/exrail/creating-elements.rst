...
Sensor polling by JMRI is independent of this, and may continue if ``<S>`` commands are used.  However there is now a way of defining JMRI sensors from within |EX-R| - see :ref:`EXRAIL Command Reference - JMRI_SENSOR </exrail/exrail-command-reference:jmri_sensor>`.
